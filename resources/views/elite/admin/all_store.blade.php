			...
			<div class="product-items">
				<div class="project-eff profile-pic">
					<div id="nivo-lightbox-demo">
						<p> <a href="{{route('admin.store', $data->store_id)}}" data-lightbox-gallery="gallery1"
								id="nivo-lightbox-demo"><span class="rollover1"> </span> </a></p>
					</div>
					<img style="    min-height: 270px;
										max-height: 270px;" class="img-responsive" src="{{asset($data->store_profile_image)}}" alt="">
					<div class="edit"><a href="{{route('admin.delete_store', $data->store_id)}}"><i

...
<body>
	...
	<div class="inner-block">
		...
		<a href="{{url('admin/all_categories')}}">
			<div class="col-md-4 market-update-gd">
					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><span
										class="@if($fb_count < 100){{'label label-info'}}@else{{'label label-success'}}@endif">@if($fb_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td> <td><span
												class="badge badge-info">{{$fb_count}}%</span></td>
							</tr>
							<tr>
								<td>2</td>
								<td>Twitter</td>
								...
								<td><span
										class="@if($fb_count < 100){{'label label-warning'}}@else{{'label label-success'}}@endif">@if($twtr_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td> <td><span
												class="badge badge-success">{{$twtr_count}}%</span></td>
							</tr>
							<tr>
								<td>3</td>
								<td>Google</td>
								...
								<td><span
										class="@if($gogle_count < 100){{'label label-info'}}@else{{'label label-success'}}@endif">@if($gogle_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td> <td><span
												class="badge badge-warning">{{$gogle_count}}%</span></td>
							</tr>
							<tr>
								<td>4</td>
								<td>LinkedIn</td>
								...
								<td><span
										class="@if($lnkd_count < 100){{'label label-warning'}}@else{{'label label-success'}}@endif">@if($lnkd_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td> <td><span
												class="badge badge-info">{{$lnkd_count}}%</span></td>
							</tr>

...
<body style="height:900px;
  ...
  overflow-x:hidden">
    ...
    @endif
    <form id="add_admin_form" class="form-horizontal" action="{{route('admin.create_admin')}}" method="post"
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="job_description" value="{{ old('job_description') }}" name="job_description"

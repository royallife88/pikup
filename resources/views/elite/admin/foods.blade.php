		...
		<div class="product-block">
			...
			<div class="col-md-3 product-grid" style="width:auto">
				<div class="product-items">
					<div class="project-eff profile-pic">
						<div id="nivo-lightbox-demo">
							<p> <a href="{{route('admin.restaurant_edit',$product->id)}}"
						...
						<div class="edit"> <a href="{{url('admin/delete/'.$product->id)}}"><i
				...
				<div class="produ-cost">
					...
					@if($product->admin_approve == '0') <h5 style="text-align:right;background:Navyblue"><span
							class="badge badge-pill badge-primary">Pending</span></h5>@endif
					@if($product->admin_approve == '1') <h5 style="text-align:right;background:Navyblue"><span
							class="badge badge-pill badge-primary">Approved</span></h5>@endif
					@if($product->admin_approve == '2') <h5 style="text-align:right;background:Navyblue"><span

...
<body class="">
  ...
  <form id="add_category" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <fieldset>
      {{csrf_field()}}
      <!-- Form Name -->
      <legend style="text-align:center"><b>Add CATEGORY</b></legend>

      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label" for="categorie_name">CATEGORY NAME</label>
        <div class="col-md-4">
          <input id="categorie_name" value="" name="category_name" placeholder="CATEGORY NAME"

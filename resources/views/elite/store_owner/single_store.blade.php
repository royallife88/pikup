...
<body class="" style="height:900px;
  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <fieldset>
      {{csrf_field()}}
      <!-- Form Name -->
      <legend style="text-align:center"><b>Edit Store</b></legend>
      <input type="hidden" name="store_id" value="{{$alldata->store_id}}">
      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label" for="store_name">STORE NAME</label>
        <div class="col-md-4">
          <input id="store_name" value="{{$alldata->store_name}}" name="title" placeholder="STORE NAME"
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="store_address" value="{{$alldata->store_address}}" name="store_address" placeholder="STORE ADDRESS"
            class="form-control input-md" required="" type="text">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <select id="product_categorie" name="store_category" class="form-control">
            ...
            <option value="{{$value->categorie_name}}" @if($alldata->store_category ==
              $value->categorie_name){{"selected"}} @endif>{{$value->categorie_name}}</option>
            @endforeach
          </select>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <textarea cols="3" rows="7" class="form-control" id="store_description"
            name="desc">{{$alldata->store_desc}}</textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          ...
          <img id="blah" height="200px" width="150px" src="{{asset('/')}}{{$alldata->store_profile_image}}"
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          ...
          <img id="banner" height="200px" width="150px" src="{{asset('/')}}{{$alldata->store_banner}}"
            class="avatar img-square img-thumbnail" alt="avatar">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="store_opening" value="{{$alldata->store_opening}}" name="store_opening" placeholder="STORE OPENING"
            class="form-control input-md" required="" type="text">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="store_closing" value="{{$alldata->store_closing}}" name="store_closing" placeholder="STORE CLOSING"
            class="form-control input-md" required="" type="text">

                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="@if($fb_count < 100){{'label label-info'}}@else{{'label label-success'}}@endif">@if($fb_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td>
                                    <td><span class="badge badge-info">{{$fb_count}}%</span></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Twitter</td>
                                    ...
                                    <td><span class="@if($fb_count < 100){{'label label-warning'}}@else{{'label label-success'}}@endif">@if($twtr_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td>
                                    <td><span class="badge badge-success">{{$twtr_count}}%</span></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Google</td>
                                    ...
                                    <td><span class="@if($gogle_count < 100){{'label label-info'}}@else{{'label label-success'}}@endif">@if($gogle_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td>
                                    <td><span class="badge badge-warning">{{$gogle_count}}%</span></td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>LinkedIn</td>
                                    ...
                                    <td><span class="@if($lnkd_count < 100){{'label label-warning'}}@else{{'label label-success'}}@endif">@if($lnkd_count
										< 100){{"in progress"}} @else{{"Completed"}} @endif</span> </td>
                                    <td><span class="badge badge-info">{{$lnkd_count}}%</span></td>
                                </tr>
            ...
            <div class="col-md-6 chart-layer2-right">
                <div class="prograc-blocks">
                    ...
                    <div class='bar_group'>
                        ...
                        <div class='bar_group__bar thin' label='Quality' show_values='true' tooltip='true' value='235'>
                        </div>
                        <div class='bar_group__bar thin' label='Amount' show_values='true' tooltip='true' value='550'></div>
                        <div class='bar_group__bar thin' label='Farming' show_values='true' tooltip='true' value='456'>
                        </div>
                    </div>
                    {{--

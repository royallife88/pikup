...
<head>
	...
	<!-- Favicon -->
	<link href="{{asset('/')}}pickupimg/favicon.ico" rel="shortcut icon"/>
	...
	<!-- Stylesheets -->
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/bootstrap.min.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/font-awesome.min.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/flaticon.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/slicknav.min.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/jquery-ui.min.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/owl.carousel.min.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/animate.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/hover.css"/>
	<link rel="stylesheet" href="{{asset('/')}}pickupcss/style.css"/>
				...
				<div class="row ml-0 mr-0 ipad_width_responsive">
					<div class="col-lg-2 text-center text-lg-left">
						...
						<a href="index.php" class="site-logo">
							<img src="img/pikup_logo_2.png" alt="">
							<!-- <p>Pikup</p> -->
						</a>
					</div>
					...
					<div class="col-lg-10">
						<div class="user-panel">
							<div class="up-item">
								...
								<a href="#" data-toggle="modal" data-target="#myModal">Sign In</a> or <a href="#!">Register</a>
							</div>
							<!-- <div class="up-item">
      ...
      <div class="row">
      	<div class="col-md-8">
      		<div class="sign_in_form">
      			...
      			<div class="forget_pass">
      				<a href="#!" style="margin-top: 0px;" data-toggle="modal" data-target="#myModal11">Don't Have An Account?</a>
      			</div>
      	...
      	<div class="col-md-4">
      		<div class="sign_popup_img">
      			<img src="{{asset('/')}}pickupimg/sign_page_img.jpg">      			
      		</div>
      	</div>
      </div>
